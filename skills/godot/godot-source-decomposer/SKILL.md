...
7. After confirmation, extract, normalize paths, preserve a small public interface, add/update registry metadata, and verify the result in a minimal fixture or the target project. Report what was changed and remaining caveats. Do not call a result reusable merely because its source scene opens.
