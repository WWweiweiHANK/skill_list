...
| [Godot](skills/godot/) | `ai-gd-code-std`、`crazygames-godot-web-compression`、`godot-button2d-faithful-extraction`、`godot-crt-scanlines`、`godot-elastic-button`、`godot-game-analytics`、`godot-game-architecture-std`、`godot-source-decomposer` | Godot 4 代码、架构、组件、埋点、UI 复用与 CrazyGames 网页包 Brotli 压缩；拆解前先核对 Theme、字体、视觉、坐标与依赖，组件资产采用相对路径以支持任意安装目录 |
